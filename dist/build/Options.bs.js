...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  // ../../src/Options.bs.js
  var require_Options_bs = __commonJS((exports) => {
    "use strict";
    var React = require_react();
    var ReactDom = require_react_dom();
    var Belt_Option = require_belt_Option();
    var Caml_option = require_caml_option();
    var partial_arg = React.createElement("div", void 0, "test");
    function render(param) {
      ReactDom.render(partial_arg, param);
    }
    Belt_Option.forEach(Caml_option.nullable_to_opt(document.querySelector("#root")), render);
    exports.render = render;
  });
  require_Options_bs();
})();
